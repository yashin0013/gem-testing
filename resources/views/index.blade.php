...
<section id="hero" class="d-flex align-items-center justify-content-between">
        ...
        <div class="form-box w-100">
          <form id="ajax-form" action="{{route('getreport')}}" class="w-100">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control h-auto" id="report_num" name="report"
  ...
  {{-- <form id="ajax-form" action="{{route('getreport')}}">
    @csrf
    <input type="text" id="report_num" name="report" placeholder="Please enter your report number"><input type="submit"
      value="Submit">
  </form>
